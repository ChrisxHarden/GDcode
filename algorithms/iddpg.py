import torch
import os
from modules.agents.mlp_agent import MLPAgent as Actor
from modules.critics.iddpg_critic import IDDPGCritic as Critic
...
class IDDPG:
    ...
    def train(self, transitions, other_agents):
        ...
        u_next = []
        with torch.no_grad():
            u_next=self.actor_target_network.forward(o_next)["actions"]
        ...
        u= self.actor_network.forward(o)["actions"]
