...
class Scenario(BaseScenario):
    ...
    def reset_world(self, world):
        ...
        targets[0].state.p_pos=np.array([-0.9,0.9])
        targets[1].state.p_pos = np.array([0, 0.9])
        targets[2].state.p_pos = np.array([0.9, 0.9])

        agents = world.agents
        agents[0].state.p_pos = np.array([-0.9, -0.9])
        agents[1].state.p_pos = np.array([0, -0.9])
        agents[2].state.p_pos = np.array([0.9, -0.9])
